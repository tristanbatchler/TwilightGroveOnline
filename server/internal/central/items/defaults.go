...
var Defaults = map[string]*objs.Item{
	...
	ironHatchetKey:    objs.NewItem("Iron hatchet", "A respectable hatchet made of iron.", 10, 128, 40, ironHatchetToolProps, 0),
	ironPickaxeKey:    objs.NewItem("Iron pickaxe", "A respectable pickaxe made of iron.", 10, 128, 64, ironPickaxeToolProps, 0),
	goldHatchetKey:    objs.NewItem("Gold hatchet", "An excellent tool, proficient in splitting logs.", 10, 128, 48, goldHatchetToolProps, 0),
